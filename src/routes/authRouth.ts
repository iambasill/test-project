...
import { loginController, registerController, resetPasswordController, verifyToken} from '../controller/authController'
...
authRoute.post('/verify-token/:token', verifyToken)
